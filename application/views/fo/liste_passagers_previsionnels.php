      ...
      <section class="wrapper site-min-height">
        <div class="row">
          <div class="col-md-12 text-center">
            <h3><i class="fa fa-plane"></i> Les passagers prévisionnels du vol</h3>
          </div>
        </div>
        ...
        <?php foreach($passagers as $passager) { ?>
            ...
            <?php if($passager->ispresent == 't'){ ?>
                <button class="btn btn-success btn-xs disabled"><i class="fa fa-check-circle-o"></i> Présent</button>
            <?php } else { ?>
                    <a href="<?php echo site_url("vol/valider_billet/".$vol->idvol."/".$passager->idbillet) ?>"><button class="btn btn-success btn-xs">Marquer comme présent</button></a>
            <?php } ?>
                  </td>
                </tr>
        <?php } ?>
