      ...
      <section class="wrapper site-min-height">
        <div class="row">
          <div class="col-md-12 text-center">
            <h3><i class="fa fa-road"></i> Nouvelle Portion de la route <?php echo $route->numroute ?> </h3>
          </div>
        </div>
          ...
          <div class="col-md-8">
            <form action="" class="form-horizontal style-form" method="post">
              <div class="form-group <?php if(form_error('pkdebut')) { echo 'has-error'; } ?>">
                ...
                <div class="col-md-4">
                  <input type="text" name="pkdebut" class="form-control" >
              ...
              <div class="form-group <?php if(form_error('pkfin')) { echo 'has-error'; } ?>">
                ...
                <div class="col-md-4">
                  <input type="text" name="pkfin" class="form-control" >
                ...
                <div class="col-md-4">
                  <select name="idetatportion" class="form-control">
                    <?php foreach($etatPortions as $etatPortion) { ?>
                      <option value="<?php echo $etatPortion->idetatportion ?>"><?php echo $etatPortion->etat." (". $etatPortion->libelleetat .")" ?></option>
                    <?php } ?>
                  </select>
              ...
              <div class="form-group col-md-6 text-center">
                <button type="submit" class="btn btn-theme">Ajouter cette portion</button>
              </div>
            </form>
          </div>
        </div>
