      ...
      <section class="wrapper site-min-height">
        <div class="row">
          <div class="col-md-12 text-center">
            <h3><i class="fa fa-gears"></i> Nouvel Etat de portion</h3>
          </div>
        </div>
          ...
          <div class="col-md-8">
            <form action="" class="form-horizontal style-form" method="post">
              ...
              <div class="form-group <?php if(form_error('libelleetat')) { echo 'has-error'; } ?>">
                ...
                <div class="col-md-4">
                  <input type="text" name="libelleetat" class="form-control" >
              ...
              <div class="form-group <?php if(form_error('coutreparation')) { echo 'has-error'; } ?>">
                ...
                <div class="col-md-4">
                  <input type="text" name="coutreparation" class="form-control" />
              ...
              <div class="form-group <?php if(form_error('dureereparation')) { echo 'has-error'; } ?>">
                ...
                <div class="col-md-4">
                  <input type="text" name="dureereparation" class="form-control" />
              ...
              <div class="form-group <?php if(form_error('coeffdeg')) { echo 'has-error'; } ?>">
                ...
                <div class="col-md-4">
                  <input type="text" name="coeffdeg" class="form-control" />
                  <p class="help-block"><?php echo form_error('coeffdeg') ?></p>
                </div>
              </div>
              <div class="form-group col-md-6 text-center">
                <button type="submit" class="btn btn-theme">Ajouter cet état de portion</button>
              </div>
            </form>
          </div>
        </div>
